...
public class UserRegistrationController {
    ...
    @ModelAttribute("user")
    public UsrRegistrationDto userRegistrationDto() {
        return new UsrRegistrationDto();
    }
    ...
    @PostMapping
    public String registerUserAccount(@ModelAttribute("user") @Valid UsrRegistrationDto userDto,
